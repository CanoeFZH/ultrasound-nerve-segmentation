...
def get_fcn():
    ...
    conv1 = Convolution2D(64, 3, 3, border_mode='same')(inputs)
    conv1 = SReLU()(conv1)
    ...
    for i in range(3):
        shortcut_y = conv1
        conv_in = BatchNormalization(axis=1)(conv1)
        conv_in = SReLU()(conv_in)
        conv_in = Convolution2D(64, 3, 3, border_mode='same')(conv_in)
        
        
        conv_out = BatchNormalization(axis=1)(conv_in)
        conv_out = SReLU()(conv_out)
        conv_out = Convolution2D(64, 3, 3, border_mode='same')(conv_out)
        
        
        y = merge([shortcut_y,conv_out],mode='sum')
        
        conv1 = Convolution2D(64, 3, 3, border_mode='same')(y)
        conv1 = SReLU()(conv1)
        conv1 = BatchNormalization(axis=1)(conv1)
        conv1 = Dropout(0.5)(conv1)
...
def train_and_predict():
    ...
    model_name = 'fcn_3_res_64_filter_seed_1024_epoch_40_no_aug_64_80_withdropout_32batch_10fold.hdf5'
