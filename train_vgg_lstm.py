...
from keras.layers import Input, merge, Convolution2D, MaxPooling2D, UpSampling2D,LSTM,Permute,Reshape,Dense
...
def get_unet():
    ...
    pool5 = Reshape((512,20))(conv5)
    pool5 = Permute((2,1))(pool5)
    
    
    lstm1 = LSTM(512)(pool5)
    lstm1 = SReLU()(lstm1)
    ...
    output
    '''
    fc1 = Dense(img_rows*img_cols,activation='sigmoid',name='location_output')(lstm1)
    
    model = Model(input=inputs, output=fc1)
...
def train_and_predict():
    ...
    print('-'*30)
    model = get_unet()
    model_name = 'vgg_lstm_seed_1024_epoch_40_no_aug_64_80_shiftbn.hdf5'
